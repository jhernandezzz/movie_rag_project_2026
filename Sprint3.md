...
- **PGVectorStore Migration:** Upgraded the backend to use `langchain-postgres.v2` and added compatibility for legacy `langchain_pg_embedding` collections, improving schema compatibility and future maintainability.
